...
namespace isu
{
	...
	public:
		...
		typedef typename myif_<is_void_result::value, this_type, result_type>::type cast_type;
...
public:
	...
	typedef typename isu::myif_<is_function_ptr<FuncPtr>::value, FuncPtr, Func>::type type;
};
...
template<class Func>
auto mati(Func fn) ->decltype(impl_mati(fn,
				std::integral_constant<bool,std::is_pointer<Func>::value>()) )
{//好吧，命名问题。。
	return impl_mati(
				fn,std::integral_constant<bool,std::is_pointer<Func>::value>() );
}
